  ...
  return (
    <button
      ...
      className={cn(
        ...
        theme ? "bg-transparent text-gray-300" : "bg-a text-gray-600",
        className,
      )}
    ...
    >
      ...
      >
        <clipPath id="skiper-btn-2">
          <motion.path
            animate={{ y: theme ? 0 : 10, x: theme ? 0 : -12 }}
            transition={{ ease: "easeInOut", duration: 0.35 }}
        ...
        <g clipPath="url(#skiper-btn-2)">
          {/* Circle = Moon base */}
          <motion.circle
            animate={{ r: theme ? 8 : 10 }} // shrink in sun mode, full in moon mode
            transition={{ ease: "easeInOut", duration: 0.35 }}
            cx="16"
            cy="16"
          />
          ...
          <motion.g
            animate={{
              rotate: theme ? 0 : -100,
              scale: theme ? 1 : 0.5,
              opacity: theme ? 1 : 0, // visible only when theme is true
            }}
            transition={{ ease: "easeInOut", duration: 0.35 }}
            stroke="currentColor"
            strokeWidth="1.5"
